...
public class Deck2
{
	...
	*/
	...
	/**
		Method returns the top card of the draw pile
	...
	*/
	...
	/**
		Method returns the top card of the discard pile
		@return The tope card of the discard pile
	*/
	...
	*/
	...
	/**
		Method removes cards from the discard pile, adds them to the draw pile, and shuffles the draw pile
	*/
